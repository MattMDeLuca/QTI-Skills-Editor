...
@XmlType(name = "NumericLogic1toMany.Type", propOrder = {
    "sumOrSubtractOrDivide"
})
public class NumericLogic1ToManyType {
    ...
    protected List<JAXBElement<?>> sumOrSubtractOrDivide;

    /**
     * Gets the value of the sumOrSubtractOrDivide property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sumOrSubtractOrDivide property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSumOrSubtractOrDivide().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getSumOrSubtractOrDivide() {
        if (sumOrSubtractOrDivide == null) {
            sumOrSubtractOrDivide = new ArrayList<JAXBElement<?>>();
        }
        return this.sumOrSubtractOrDivide;
    }
