 ...
 *       &lt;sequence>
 *         &lt;element name="curriculumStandardsMetadata" type="{http://www.imsglobal.org/xsd/imsccv1p2/imscsmd_v1p0}CurriculumStandardsMetadata.Type" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
public class CurriculumStandardsMetadataSetType {

    @XmlElement(required = true)
    protected List<CurriculumStandardsMetadataType> curriculumStandardsMetadata;
    ...
    /**
     * Gets the value of the curriculumStandardsMetadata property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the curriculumStandardsMetadata property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCurriculumStandardsMetadata().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CurriculumStandardsMetadataType> getCurriculumStandardsMetadata() {
        if (curriculumStandardsMetadata == null) {
            curriculumStandardsMetadata = new ArrayList<CurriculumStandardsMetadataType>();
        }
